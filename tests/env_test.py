...
ENV_TEST_FILE = os.path.join(os.path.dirname(
    os.path.abspath(__file__)), "env_test_file.bash")
...
def test_searchFile():
    ...
    assert env.JSONConfigReader.searchFile(
        env_in_test_files_dir) == abspath(env.__file__)
